...
class SeriesDetailsScreen extends StatelessWidget {
  const SeriesDetailsScreen({super.key, required this.tvModel});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // backgroundColor: ,
      // backgroundColor: Apptheme.myPrimaryColor,
      // appBar: AppBar(
      ...
      body: Stack(
        children: [
          Opacity(
            opacity: 0.6,
            child: Image.network(
              'https://image.tmdb.org/t/p/w500${tvModel.backdropPath}',
              fit: BoxFit.fill,
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(
                        vertical: 1.0, horizontal: 25),
                    child: Text(
                      'Language: ${tvModel.originalLanguage}',
                      style: Apptheme.appBarTextLarge,
                      textAlign: TextAlign.start,
                      // overflow: TextOverflow.clip,
                    ),
